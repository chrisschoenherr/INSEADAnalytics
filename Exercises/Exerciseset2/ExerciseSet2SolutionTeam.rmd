...
author: "Christian Schoenherr, Jose Sanchez, Oskar Feng"
...
**Your Answers here:**
<br>
Question1: We need 6 components to explain 52.29%
<br>
Question2: The highest weights are 0.93
<br>
Question 3: The first 10 components could be described as follows: Bonds, Currencies, European Stocks, North American Stocks, Euro, Oil and Gas, Metals, Commodities, Precious metals, Asian Stocks
<br>
Question 4: 
...
Question 5: From the analysis we can see that during a crisis, financial assets are much more correlated. During the crisis the Eigenvalues are higher and the curve is steeper, which means that we can explain more with the same amount of factors or even fewer factors.
<br>
...
**Your Answers here:**
<br>
Answer 1: First, the algorithm determines a set of sequencial numbers at a set distance, next it identifies if a certain asset has gone up (+) or down (-) in a  certain year and assigns this sign to a table. Finally it "votes" to see if the algorithm should buy or sell a certain asset.
<br>
<br>
Answer 2: If you change the moving average then the performance of this strategy will change as well.
<br>
